...
# Pro každé náboženství v daném státu bych chtìl procentní podíl jeho pøíslušníkù na celkovém obyvatelstvu.
...
#missing countries- zemì, které nejsou uvedeny buï v žádné tabulce nebo jen v covid19_basic_differences
...
#from religions r;
  ...
  #ve finální tabulce je zastoupeno pouze 16 zemí, protože potøebujeme data jak pro poèty nakažených, tak pro poèet testovaných. V opaèném pøípadì je pozorování zkreslené.
  #select distinct country
